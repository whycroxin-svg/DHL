--[[
    DHL V2 - PREMIUM EDITION
    Paralı hileler gibi gorunum
    Animasyonlar, glow, gradient, ikonlar
    Hook YOK
]]

print("[DHL V2] PREMIUM yukleniyor...")
...
-- =============================================
-- THEMES (Premium Palet)
-- =============================================
local Themes = {
    Midnight = {Name="Midnight", Primary=Color3.fromRGB(88,101,242), Accent=Color3.fromRGB(120,140,255), Bg=Color3.fromRGB(15,17,26),  Panel=Color3.fromRGB(24,27,38),  Button=Color3.fromRGB(38,42,58),  Text=Color3.fromRGB(140,160,255), Gradient1=Color3.fromRGB(88,101,242), Gradient2=Color3.fromRGB(180,100,240)},
    Aurora   = {Name="Aurora",   Primary=Color3.fromRGB(0,180,180),  Accent=Color3.fromRGB(80,240,200), Bg=Color3.fromRGB(10,20,25),  Panel=Color3.fromRGB(18,32,40),  Button=Color3.fromRGB(28,50,60),  Text=Color3.fromRGB(100,240,220), Gradient1=Color3.fromRGB(0,180,180), Gradient2=Color3.fromRGB(0,120,220)},
    Sunset   = {Name="Sunset",   Primary=Color3.fromRGB(240,100,60), Accent=Color3.fromRGB(255,150,80), Bg=Color3.fromRGB(25,15,20),  Panel=Color3.fromRGB(40,22,30),  Button=Color3.fromRGB(60,35,45),  Text=Color3.fromRGB(255,160,120), Gradient1=Color3.fromRGB(240,100,60), Gradient2=Color3.fromRGB(180,40,120)},
    Neon     = {Name="Neon",     Primary=Color3.fromRGB(255,20,150), Accent=Color3.fromRGB(255,100,200),Bg=Color3.fromRGB(20,5,20),   Panel=Color3.fromRGB(35,10,35),  Button=Color3.fromRGB(55,20,55),  Text=Color3.fromRGB(255,120,200), Gradient1=Color3.fromRGB(255,20,150), Gradient2=Color3.fromRGB(120,20,255)},
    Emerald  = {Name="Emerald",  Primary=Color3.fromRGB(0,200,100),  Accent=Color3.fromRGB(80,255,150), Bg=Color3.fromRGB(10,20,15),  Panel=Color3.fromRGB(18,35,25),  Button=Color3.fromRGB(30,55,40),  Text=Color3.fromRGB(100,255,170), Gradient1=Color3.fromRGB(0,200,100), Gradient2=Color3.fromRGB(0,150,80)},
    Crimson  = {Name="Crimson",  Primary=Color3.fromRGB(220,30,60),  Accent=Color3.fromRGB(255,100,120),Bg=Color3.fromRGB(25,10,15),  Panel=Color3.fromRGB(40,18,25),  Button=Color3.fromRGB(60,30,40),  Text=Color3.fromRGB(255,140,160), Gradient1=Color3.fromRGB(220,30,60), Gradient2=Color3.fromRGB(150,20,150)},
    Ocean    = {Name="Ocean",    Primary=Color3.fromRGB(40,130,220), Accent=Color3.fromRGB(100,180,255),Bg=Color3.fromRGB(10,18,30),  Panel=Color3.fromRGB(18,30,50),  Button=Color3.fromRGB(30,48,75),  Text=Color3.fromRGB(120,180,255), Gradient1=Color3.fromRGB(40,130,220), Gradient2=Color3.fromRGB(80,80,220)},
    Monochrome = {Name="Monochrome", Primary=Color3.fromRGB(200,200,200), Accent=Color3.fromRGB(255,255,255), Bg=Color3.fromRGB(12,12,14), Panel=Color3.fromRGB(22,22,26), Button=Color3.fromRGB(38,38,44), Text=Color3.fromRGB(220,220,220), Gradient1=Color3.fromRGB(200,200,200), Gradient2=Color3.fromRGB(120,120,120)},
}
...
local Settings = {
    ...
    HighlightFillTransparency = 0.35, HighlightColor = Color3.fromRGB(88,101,242),
    ...
    Watermark = true, FPSDisplay = true, PingDisplay = true, GuiTransparency = 0.03,
...
local function showToast(title, message, toastType)
    ...
    tween(toast, 0.4, {Position = UDim2.new(0, 0, 0, 0), BackgroundTransparency = 0.05}, Enum.EasingStyle.Back)
    tween(titleLbl, 0.4, {TextTransparency = 0})
    tween(msgLbl, 0.4, {TextTransparency = 0})
    
    -- Cikis animasyonu
    task.delay(3, function()
        tween(toast, 0.3, {Position = UDim2.new(1, 40, 0, 0), BackgroundTransparency = 1}, Enum.EasingStyle.Quad, Enum.EasingDirection.In)
...
task.spawn(function()
    while MainFrame.Parent do
        tween(glowStroke, 2, {Transparency = 0.7}, Enum.EasingStyle.Sine, Enum.EasingDirection.InOut)
        task.wait(2)
        tween(glowStroke, 2, {Transparency = 0.2}, Enum.EasingStyle.Sine, Enum.EasingDirection.InOut)
        task.wait(2)
    end
end)
...
BgImage.BackgroundTransparency = 1; BgImage.ImageTransparency = 0.92
...
tl.Size = UDim2.new(1, 0, 0, 24); tl.Position = UDim2.new(0, 20, 0, 8)
...
cl.Size = UDim2.new(1, 0, 0, 14); cl.Position = UDim2.new(0, 20, 0, 30)
cl.BackgroundTransparency = 1
cl.Text = "PREMIUM EDITION  •  v5"
cl.TextColor3 = Color3.fromRGB(150,150,165)
cl.TextSize = 10
...
-- Kapat butonu (animasyonlu)
local closeBtn = Instance.new("TextButton")
closeBtn.Size = UDim2.new(0, 28, 0, 28); closeBtn.Position = UDim2.new(1, -40, 0, 14)
...
closeBtn.MouseEnter:Connect(function()
    tween(closeBtn, 0.2, {BackgroundColor3 = Color3.fromRGB(200, 60, 60), BackgroundTransparency = 0, TextColor3 = Color3.fromRGB(255,255,255)})
    tween(closeBtn, 0.2, {Size = UDim2.new(0, 32, 0, 32), Position = UDim2.new(1, -42, 0, 12)})
end)
closeBtn.MouseLeave:Connect(function()
    tween(closeBtn, 0.2, {BackgroundColor3 = Color3.fromRGB(60, 25, 30), BackgroundTransparency = 0.3, TextColor3 = Color3.fromRGB(255,120,120)})
    tween(closeBtn, 0.2, {Size = UDim2.new(0, 28, 0, 28), Position = UDim2.new(1, -40, 0, 14)})
end)
closeBtn.MouseButton1Click:Connect(function()
    tween(MainFrame, 0.25, {Size = UDim2.new(0, 720, 0, 0), Position = UDim2.new(0.5, -360, 0.5, 0)}, Enum.EasingStyle.Back, Enum.EasingDirection.In)
    task.wait(0.25)
...
minBtn.Size = UDim2.new(0, 28, 0, 28); minBtn.Position = UDim2.new(1, -74, 0, 14)
minBtn.BackgroundColor3 = Color3.fromRGB(60, 55, 25); minBtn.BackgroundTransparency = 0.3
minBtn.BorderSizePixel = 0
minBtn.Text = "−"; minBtn.TextColor3 = Color3.fromRGB(255,220,120)
minBtn.TextSize = 14; minBtn.Font = Enum.Font.GothamBold; minBtn.AutoButtonColor = false
minBtn.ZIndex = 11; minBtn.Parent = MainFrame
Instance.new("UICorner", minBtn).CornerRadius = UDim.new(1, 0)
minBtn.MouseEnter:Connect(function()
    tween(minBtn, 0.2, {BackgroundColor3 = Color3.fromRGB(240, 200, 60), BackgroundTransparency = 0, TextColor3 = Color3.fromRGB(0,0,0)})
end)
minBtn.MouseLeave:Connect(function()
    tween(minBtn, 0.2, {BackgroundColor3 = Color3.fromRGB(60, 55, 25), BackgroundTransparency = 0.3, TextColor3 = Color3.fromRGB(255,220,120)})
end)
...
Sidebar.Size = UDim2.new(0, 155, 1, -105)
...
sideGradient.Color = ColorSequence.new({
    ...
    ColorSequenceKeypoint.new(1, Color3.fromRGB(CurrentTheme.Panel.R*255*0.7/255, CurrentTheme.Panel.G*255*0.7/255, CurrentTheme.Panel.B*255*0.7/255)),
})
...
avatarCircle.Position = UDim2.new(0, 6, 0.5, -18)
...
profileStatus.Size = UDim2.new(1, -50, 0, 14)
profileStatus.Position = UDim2.new(0, 48, 0, 26)
profileStatus.BackgroundTransparency = 1
profileStatus.Text = "● Online"
profileStatus.TextColor3 = Color3.fromRGB(80, 220, 120)
...
-- Sidebar scroll (tablar icin)
local SideScroll = Instance.new("ScrollingFrame")
SideScroll.Size = UDim2.new(1, -12, 1, -75)
SideScroll.Position = UDim2.new(0, 6, 0, 62)
...
ContentArea.Size = UDim2.new(1, -190, 1, -105)
ContentArea.Position = UDim2.new(0, 175, 0, 90)
...
local function animatePageSwitch(newPage)
    for _, page in pairs(tabPages) do
        if page.Visible and page ~= newPage then
            tween(page, 0.15, {BackgroundTransparency = 1})
            page.Visible = false
        end
    end
    newPage.Visible = true
    newPage.Position = UDim2.new(0, 20, 0, 0)
    tween(newPage, 0.3, {Position = UDim2.new(0, 0, 0, 0)}, Enum.EasingStyle.Quint, Enum.EasingDirection.Out)
end
...
local function addToggle(page, name, default, callback, order, withKeybind)
    ...
    local toggleWidth = withKeybind and UDim2.new(1, -70, 1, 0) or UDim2.new(1, 0, 1, 0)
    ...
    if withKeybind then
        ...
        kbBtn.Size = UDim2.new(0, 62, 1, 0)
        kbBtn.Position = UDim2.new(1, -62, 0, 0)
...
local function addButton(page, name, callback, order, color)
    ...
    btn.MouseButton1Click:Connect(function()
        -- Shine efekti
        tween(btn, 0.1, {BackgroundTransparency = 0})
        tween(stroke, 0.1, {Transparency = 0.3})
        task.wait(0.1)
...
SelectCountLabel.Size = UDim2.new(1,-8,0,18)
...
ClearAllBtn.MouseLeave:Connect(function() tween(ClearAllBtn, 0.15, {BackgroundColor3 = Color3.fromRGB(80, 30, 30)}) end)
    ...
    for _, plr in pairs(Settings.SelectedPlayers) do
        if plr and plr.Character then
            ...
            if hum then
                ...
                showToast("Kill", plr.DisplayName .. " olduruldu", "success")
            end
            break
        end
    end
end, 10, Color3.fromRGB(200, 40, 60))
...
worldInfoLabel.Size = UDim2.new(1,-8,0,70)
...
end, 13, Color3.fromRGB(180, 100, 30))
...
end, 14, Color3.fromRGB(40, 160, 80))

-- PAGE 7: SETTINGS
local p7 = tabPages["Settings"]
addLabel(p7, "▸ THEME", 1)
local getTheme = addCycleButton(p7, "Theme", {"Midnight","Aurora","Sunset","Neon","Emerald","Crimson","Ocean","Monochrome"}, "Midnight", function(v)
    if Themes[v] then
        ...
        showToast("Theme", CurrentTheme.Name .. " temasina gecildi", "success")
    end
end, 2)
...
end, 13, Color3.fromRGB(40, 100, 180))
...
end, 14, Color3.fromRGB(40, 100, 180))

addSeparator(p7, 15)
addLabel(p7, "▸ STATISTICS", 16)
local statLabel = Instance.new("TextLabel")
statLabel.Size = UDim2.new(1,-8,0,70)
...
Watermark.Size = UDim2.new(0, 240, 0, 40)
...
wmTitle.Size = UDim2.new(1, 0, 0, 20)
wmTitle.Position = UDim2.new(0, 10, 0, 4)
wmTitle.BackgroundTransparency = 1
wmTitle.Text = "◆ DHL V2  •  PREMIUM"
wmTitle.TextColor3 = Color3.fromRGB(255,255,255)
wmTitle.TextSize = 12
...
wmInfo.Position = UDim2.new(0, 10, 0, 22)
...
UserInputService.InputBegan:Connect(function(input, gpe)
    ...
    if input.KeyCode == Enum.KeyCode.RightShift then
        ...
        if MainFrame.Visible then
            MainFrame.Size = UDim2.new(0, 720, 0, 500)
            tween(MainFrame, 0.3, {Size = UDim2.new(0, 720, 0, 500)}, Enum.EasingStyle.Back)
        end
    end
...
-- BILDIRIM
-- =============================================
print("[DHL V2] PREMIUM EDITION - LOADED!")
print("[DHL V2] Animasyonlar, glow, gradient, ikonlar aktif")
print("[DHL V2] Right Shift = GUI")

task.wait(0.5)
showToast("DHL V2 Premium", "Basarili yuklendi!", "success")
task.wait(0.5)
showToast("Kullanim", "Right Shift ile GUI'yi ac/kapa", "info")

pcall(function()
    game:GetService("StarterGui"):SetCore("SendNotification", {
        Title = "DHL V2 PREMIUM",
        Text = "Animasyonlu premium surum yuklendi!",
        Duration = 5
    })
end)
